...
exports.createTicket = async (req, res) => {
  ...
  /**
   * Logic to find random Engineer in the Approved state
   */
...
exports.updateTicket = async (req, res) => {
  ...
  if (
    ...
    ticket.updatedAt = new Date().toLocaleString().toString();
    ...
    /**
     * Sending the notification for ticket updating
     */
    // sendEmail(
    //   ticket._id,
...
/**
 * Get the list of all the tickets created by  or assigned to me
 */
